...
namespace DemoConnector.TwinfieldAPI.Demo
{
    public class CustomerDemo
    {
        ...
        private DemoConnector.TwinfieldAPI.Data.Customers.Customer customer;
        ...
        public void Run()
        {
            ...
            var cust = new DemoConnector.TwinfieldAPI.Data.Customers.Customer
            {
                Office = session.Office,
                Type = "DEB",
                Name = "test2",
            ...
            var delCust = new DemoConnector.TwinfieldAPI.Data.Customers.Customer
            {
                Type = "DEB",
                Code = "1010"
            };
//            customerService.DeleteCustomer(delCust);
            ...
            post.Add(p);
            var delPost = new DemoConnector.TwinfieldAPI.Data.Customers.Customer
            {
                Office = session.Office,
                Type = "DEB",
                Code = "1011",
        ...
        private static void DisplayCustomerDetails(DemoConnector.TwinfieldAPI.Data.Customers.Customer customer)
        {
            Console.WriteLine("------");
